...
Usage:
python process_T1_to_BIDS.py <dicom_root_dir> <bids_root_dir_dir> [--pydeface]
e.g.,
python process_T1_to_BIDS.py /path/to/dicom_root_dir /path/to/bids_root_dir_dir --pydeface
...
if __name__ == "__main__":
    ...
    Usage:
    process_T1_to_BIDS.py <dicom_root_dir> <bids_root_dir> [--pydeface]
    """
