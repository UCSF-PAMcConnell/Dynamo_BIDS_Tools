...
if __name__ == "__main__":
    ...
    pydeface_command = f"python {pydeface_path} {output_dir}/anat/'sub-{subject_id}_ses-{session_id}_T1w'.nii --outfile {output_dir}/anat/'sub-{subject_id}_ses-{session_id}_T1w'.nii --force"
