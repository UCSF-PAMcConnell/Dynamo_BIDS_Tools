"""
process_fmap_gre_ses_1_to_BIDS.py
...
Usage:
python process_fmap_gre_ses_1_to_BIDS.py <dicom_root_dir> <bids_root_dir>
e.g.,
python process_fmap_gre_ses_1_to_BIDS.py /path/to/dicom_root_dir /path/to/bids_root_dir 
...
if __name__ == "__main__":
    ...
    Usage:
    process_fmap_gre_ses_1_to_BIDS.py <dicom_root_dir> <bids_root_dir>
